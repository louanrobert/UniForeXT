...
import be.ccb_uliege.incd.uniforext_viewer.services.KGService;
import be.ccb_uliege.incd.uniforext_viewer.views.EventExplorerView;
import be.ccb_uliege.incd.uniforext_viewer.views.FastTimelineView;
import be.ccb_uliege.incd.uniforext_viewer.views.GraphView;
import be.ccb_uliege.incd.uniforext_viewer.views.QueryView;
import be.ccb_uliege.incd.uniforext_viewer.views.UndatedEventsView;
import be.ccb_uliege.incd.uniforext_viewer.views.ViewSelectorView;
...
public class App extends Application {
    ...
    private void loadOntologyAsync(String ttlPath) {
        ...
        primaryStage.setTitle("KG Viewer — Loading...");
        ...
        loadTask.setOnSucceeded(event -> {
            try {
                ...
                primaryStage.setTitle("KG Viewer — " + new File(ttlPath).getName());
                showViewSelector();
                LOG.info("KG loaded successfully");
            } catch (Exception e) {
